...
class FeedController extends Zend_Controller_Action{
    public function init(){
        ...
        $feed->setLink('http://www.tadikapertiwi.net');
        $feed->setFeedLink('http://www.tadikapertiwi.net/feed', 'rss');
        $feed->setDescription('Sekolah Tadika Pertiwi');
        $feed->addAuthor(array(
            'name'  => 'Panjat Pinang',
            'uri'   => 'http://www.tadikapertiwi.com',
        ...
        */
        if($this->_getParam("id") == null){
            foreach ($Materi as $mm){
                ...
                $entry->setLink('http://tadikapertiwi.net/feed/rss/id/'. $mm->id_materi);
